...
class WallPitLeft(AbstractObstacle):

    def __init__(self, *args, **kwargs):
        super(WallPitLeft, self).__init__(*args, **kwargs)
        self.ticker = Ticker()
        self.ticker.start()
    ...
    def __del__(self):
        ...
        super(WallPitLeft, self).__del__()

    def on_node_removed(self, *args, **kwargs):
        self.ticker.clear()
        self.transition_manager.clear()
        super(WallPitLeft, self).on_node_removed(*args, **kwargs)
